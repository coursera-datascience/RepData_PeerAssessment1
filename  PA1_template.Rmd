...
Overall, activity starts to increase right after the interval 500 (early  morning, around after 5am). Activity peaks at the interval at 835 (during the moring commute, around 8:35am), and ramins relatively high until around the interval 1900 (early evening, around 7pm) with some fluctuation. After then, activity decreases continuously.
```{r echo = TRUE}
...
plot(avg_steps_every_5min$interval, avg_steps_every_5min$steps, type="l", xlab="Interval", ylab="Steps")
legend("topright", c("mean","median"), lty=c(1,1), col=c("red","blue"), cex=0.9)
dev.off()
